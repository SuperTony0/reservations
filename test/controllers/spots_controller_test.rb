...
class SpotsControllerTest < ActionController::TestCase
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post :create, spot: { description: @spot.description, room_id: @spot.room_id, user_id: @spot.user_id }
    end
  ...
  test "should update spot" do
    patch :update, id: @spot, spot: { description: @spot.description, room_id: @spot.room_id, user_id: @spot.user_id }
    assert_redirected_to spot_path(assigns(:spot))
  end
